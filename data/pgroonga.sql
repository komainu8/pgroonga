...
CREATE FUNCTION pgroonga_language_model_vectorize(model_name cstring, target text)
	RETURNS float4[]
...
CREATE OR REPLACE FUNCTION pgroonga_physical_table_names(logical_table_name text, argument_name text)
	RETURNS text[]
